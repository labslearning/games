          ...
          {activeQuiz && (
            <div style={ui.quizOverlay}>
              <div style={ui.quizBox}>
                ...
                {quizFeedback && (
                  <div style={{ padding: '30px', background: quizFeedback.type === 'success' ? 'rgba(0,255,0,0.1)' : 'rgba(255,0,85,0.1)', border: `2px solid ${quizFeedback.type === 'success' ? '#0f0' : '#ff0055'}`, color: quizFeedback.type === 'success' ? '#0f0' : '#ff0055', fontSize: '18px', borderRadius: '8px', textAlign: 'left' }}>
