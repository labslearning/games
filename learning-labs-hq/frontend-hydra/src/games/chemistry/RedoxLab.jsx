...
/* ============================================================
   🌍 2. DICCIONARIO GLOBAL (TERMODINÁMICA)
============================================================ */
const DICT = {
  es: {
    ui: { 
...
const QuantumPiston = ({ temp, volume, pressure, isCritical, isMobile, isLandscape }) => {
  ...
  const htmlPos = isMobile ? (isLandscape ? [5.5, 2, 0] : [0, 6.8, 0]) : [4.5, 5, 0];
...
export default function GasTheory() {
  ...
  const [isCorrectAnswer, setIsCorrectAnswer] = useState(false); // 🔥 FIX Cuelgue visual
  ...
  // 🔥 FIX DEL BOTÓN PEGADO (Transición Fluida de 1.5s)
  ...
  if (phase === "BOOT") return (
    <div className="screen-container" style={ui.overlayFull}>
  ...
  if (phase === "END") return (
    <div className="screen-container" style={ui.overlayFull}>
      <h1 className="title-glow" style={{color: '#0f0', fontSize: 'clamp(32px, 8vw, 70px)', textShadow: '0 0 50px #0f0', letterSpacing: 'clamp(2px, 2vw, 10px)', textAlign:'center', margin:'0', width: '100%', boxSizing: 'border-box'}}>{d.ui.winTitle}</h1>
  ...
  return (
    <div className="screen-container" style={ui.screen}>
      ...
      <div style={{position:'absolute', inset:0, zIndex:1, pointerEvents:'none'}}>
        {/* 🔥 FIX CÁMARA MOBILE: Z:28 en vertical, Z:18 en horizontal, Z:16 en PC */}
