...
export const i18n = {
  es: { 
    ...
    quizzes: {
      FREE: [ { question: "¿Qué determina si el material es Sólido, Líquido o Gas?", options: [ { text: "Relación de T con Fusión/Ebullición", correct: true, explanation: "¡Correcto! La temperatura es el factor clave que determina la fase de la materia." }, { text: "La presión del pistón", correct: false, explanation: "Recuerda: Aunque la presión influye, en este modelo ideal la Temperatura es el factor dominante que define si cruzas los puntos de fusión o ebullición." }, { text: "El volumen", correct: false, explanation: "El volumen afecta la presión, no la fase directamente. La temperatura es la clave." }, { text: "La masa", correct: false, explanation: "La masa es una propiedad intrínseca del elemento (constante), no cambia el estado físico." } ] } ],
      BOYLE: [ { question: "EJERCICIO: Si P1=15 PSI y V1=100%. ¿Cuál es P2 si V2=50%?", options: [ { text: "30 PSI", correct: true, explanation: "¡Correcto! La Ley de Boyle dicta P1*V1 = P2*V2. Por tanto: (15*100)/50 = 30." }, { text: "7.5 PSI", correct: false, explanation: "Te equivocaste de operación. La Ley de Boyle dice que Volumen y Presión son inversamente proporcionales. Si el volumen baja a la mitad, la presión debe DUPLICARSE." }, { text: "15 PSI", correct: false, explanation: "Imposible. Si cambias el volumen, la presión DEBE cambiar para mantener el equilibrio en la Ley de Boyle." }, { text: "50 PSI", correct: false, explanation: "Error de cálculo. Usa la fórmula: P2 = (P1 * V1) / V2. Inténtalo de nuevo." } ] } ],
      CHARLES: [ { question: "EJERCICIO: Si T1=300K y V1=100%. Al calentar a T2=600K, ¿qué le pasa a V2?", options: [ { text: "Sube a 200%", correct: true, explanation: "¡Correcto! Según Charles, V y T son directamente proporcionales. V1/T1 = V2/T2." }, { text: "Baja a 50%", correct: false, explanation: "Recuerda la Ley de Charles: El calor expande los gases, no los contrae. Al subir la temperatura, el volumen debe subir proporcionalmente." }, { text: "Se queda en 100%", correct: false, explanation: "Si calientas un gas y no le das más espacio (volumen), la presión explotaría, rompiendo la regla de Charles de Presión Constante." }, { text: "Sube a 600%", correct: false, explanation: "Calculaste mal la proporción. La temperatura se duplicó (de 300 a 600), así que el volumen también debe duplicarse." } ] } ],
      GAY_LUSSAC: [ { question: "Volumen bloqueado. Si subes la temperatura drásticamente...", options: [ { text: "Presión aumenta", correct: true, explanation: "¡Correcto! Mayor temperatura significa mayor energía cinética y más impactos contra las paredes." }, { text: "Presión disminuye", correct: false, explanation: "Recuerda la Ley de Gay-Lussac: El calor añade energía. Las partículas se mueven más rápido, por lo que la presión AUMENTA." }, { text: "Átomos frenan", correct: false, explanation: "La temperatura es literalmente la medida del movimiento de las partículas. Más calor = más velocidad." }, { text: "Pierde masa", correct: false, explanation: "Este es un sistema cerrado hermético. La materia (masa) no puede entrar ni salir." } ] } ]
    }
  },
  en: { 
    ...
    quizzes: {
      FREE: [ { question: "What determines if the material is Solid, Liquid or Gas?", options: [ { text: "T relation with Melting/Boiling", correct: true, explanation: "Correct! Temperature dictates the phase." }, { text: "Piston pressure", correct: false, explanation: "Remember: While pressure has an effect, in this ideal model, Temperature is the dominant factor." }, { text: "Volume", correct: false, explanation: "Volume changes pressure, not phase directly. Temperature is key." }, { text: "Mass", correct: false, explanation: "Mass is a constant intrinsic property, it does not change the physical state." } ] } ],
      BOYLE: [ { question: "MATH: If P1=15 PSI and V1=100%. What is P2 if V2=50%?", options: [ { text: "30 PSI", correct: true, explanation: "Correct! Boyle's Law states P1*V1 = P2*V2. Thus: (15*100)/50 = 30." }, { text: "7.5 PSI", correct: false, explanation: "Wrong operation. Boyle's law says Volume and Pressure are inversely proportional. If volume halves, pressure DOUBLES." }, { text: "15 PSI", correct: false, explanation: "Impossible. If volume changes, pressure MUST change to maintain balance." }, { text: "50 PSI", correct: false, explanation: "Math error. Use the formula: P2 = (P1 * V1) / V2. Try again." } ] } ],
      CHARLES: [ { question: "MATH: If T1=300K and V1=100%. Heat to T2=600K, what is V2?", options: [ { text: "Rises to 200%", correct: true, explanation: "Correct! According to Charles, V and T are directly proportional. V1/T1 = V2/T2." }, { text: "Drops to 50%", correct: false, explanation: "Remember Charles's Law: Heat expands gases, it doesn't contract them. As temperature rises, volume must rise proportionally." }, { text: "Stays 100%", correct: false, explanation: "If you heat a gas without giving it more space, pressure would explode, breaking the Constant Pressure rule." }, { text: "Rises to 600%", correct: false, explanation: "Proportion error. Temperature doubled (300 to 600), so volume must also double." } ] } ],
      GAY_LUSSAC: [ { question: "Locked volume. If you raise temperature...", options: [ { text: "Pressure rises", correct: true, explanation: "Correct! Higher temperature means higher kinetic energy and more impacts against walls." }, { text: "Pressure drops", correct: false, explanation: "Remember Gay-Lussac's Law: Heat adds energy. Particles move faster, so pressure INCREASES." }, { text: "Atoms stop", correct: false, explanation: "Temperature is literally the measurement of particle movement. More heat = more speed." }, { text: "Loses mass", correct: false, explanation: "This is a closed hermetic system. Matter (mass) cannot enter or leave." } ] } ]
    }
  },
  fr: { 
    ...
    quizzes: {
      FREE: [ { question: "Qu'est-ce qui détermine l'état (Solide, Liquide, Gaz)?", options: [ { text: "Relation T avec Fusion", correct: true, explanation: "Correct! La température dicte la phase." }, { text: "Pression du piston", correct: false, explanation: "Rappelez-vous: La température est le facteur dominant." }, { text: "Le volume", correct: false, explanation: "Le volume modifie la pression, pas la phase." }, { text: "Masse", correct: false, explanation: "La masse est constante." } ] } ],
      BOYLE: [ { question: "MATH: Si P1=15 PSI et V1=100%. Quelle est P2 si V2=50%?", options: [ { text: "30 PSI", correct: true, explanation: "Correct! P1*V1 = P2*V2. Donc: (15*100)/50 = 30." }, { text: "7.5 PSI", correct: false, explanation: "Faux. La loi de Boyle dit: volume diminue, pression AUGMENTE." }, { text: "15 PSI", correct: false, explanation: "Faux. La pression doit changer." }, { text: "50 PSI", correct: false, explanation: "Faux. Erreur de calcul." } ] } ],
      CHARLES: [ { question: "MATH: Si T1=300K et V1=100%. À T2=600K, que devient V2?", options: [ { text: "Monte à 200%", correct: true, explanation: "Correct! V1/T1 = V2/T2." }, { text: "Baisse à 50%", correct: false, explanation: "Faux. La chaleur dilate les gaz." }, { text: "Reste à 100%", correct: false, explanation: "Faux. La pression exploserait." }, { text: "Monte à 600%", correct: false, explanation: "Faux. Erreur de proportion." } ] } ],
      GAY_LUSSAC: [ { question: "Volume fixe. Si vous augmentez la température...", options: [ { text: "Pression augmente", correct: true, explanation: "Correct! Plus d'énergie cinétique." }, { text: "Pression diminue", correct: false, explanation: "Faux. La chaleur ajoute de l'énergie, la pression augmente." }, { text: "Atomes arrêtent", correct: false, explanation: "Faux. La chaleur les accélère." }, { text: "Perd masse", correct: false, explanation: "Faux. Système fermé." } ] } ]
    }
  },
  de: { 
    ...
    quizzes: {
      FREE: [ { question: "Was bestimmt den Zustand (Fest, Flüssig, Gas)?", options: [ { text: "T-Verhältnis", correct: true, explanation: "Richtig! T ist der Hauptfaktor." }, { text: "Kolbendruck", correct: false, explanation: "Denk daran: Temperatur ist dominant." }, { text: "Volumen", correct: false, explanation: "Falsch. Volumen ändert Druck." }, { text: "Masse", correct: false, explanation: "Falsch. Masse ist konstant." } ] } ],
      BOYLE: [ { question: "MATH: Wenn P1=15 PSI, V1=100%. Was ist P2 bei V2=50%?", options: [ { text: "30 PSI", correct: true, explanation: "Richtig! Halbes Volumen = Doppelter Druck. (15*100)/50 = 30." }, { text: "7.5 PSI", correct: false, explanation: "Falsch. Wenn V sinkt, MUSS P steigen." }, { text: "15 PSI", correct: false, explanation: "Falsch. Druck muss sich ändern." }, { text: "50 PSI", correct: false, explanation: "Falsch. Rechenfehler." } ] } ],
      CHARLES: [ { question: "MATH: T1=300K, V1=100%. Bei T2=600K, was ist V2?", options: [ { text: "Steigt auf 200%", correct: true, explanation: "Richtig! Hitze dehnt Gas aus. V1/T1 = V2/T2." }, { text: "Fällt auf 50%", correct: false, explanation: "Falsch. Hitze dehnt aus, zieht nicht zusammen." }, { text: "Bleibt bei 100%", correct: false, explanation: "Falsch. Druck würde explodieren." }, { text: "Steigt auf 600%", correct: false, explanation: "Falsch. Proportionsfehler." } ] } ],
      GAY_LUSSAC: [ { question: "Festes Volumen. T steigt...", options: [ { text: "Druck steigt", correct: true, explanation: "Richtig! Mehr kinetische Energie." }, { text: "Druck fällt", correct: false, explanation: "Falsch. Mehr Hitze = mehr Druck." }, { text: "Atome stoppen", correct: false, explanation: "Falsch. Hitze beschleunigt sie." }, { text: "Verliert Masse", correct: false, explanation: "Falsch. Geschlossenes System." } ] } ]
    }
  }
};
...
export const useGameStore = create(
  persist(
    (set, get) => ({
      ...
      resetProgress: () => { audioSys.play('snd-cool'); set({ appState: 'LANG_SELECT', temp: 300, volume: 100, pressure: 14.7, activeMode: 'FREE', activeQuiz: null, quizFeedback: null, exampleSession: null, interactionCount: 0 }); },
      ...
      triggerExercise: () => {
        ...
        if (dict && dict.length > 0) {
          ...
          set({ activeQuiz: { title: i18n[state.language].ui.generate, question: randomQ.question, options: shuffledOptions }, quizFeedback: null });
          audioSys.playQuiz();
        }
      },
    ...
    }), { name: 'll-omega-multilang-final-v6' }
  )
);
